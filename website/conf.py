...
BLOG_AUTHOR = "Aaron Yong"  # (translatable)
BLOG_TITLE = "Aaron Yong"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://aarony.dev/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://aarony.dev/"
BLOG_EMAIL = "hello@aarony.dev"
BLOG_DESCRIPTION = "This is a website for my professional portfolio."  # (translatable)
...
# config.
# See: http://docutils.sourceforge.net/docs/user/config.html#file-insertion-enabled
...
#        "open source": "My contributions to my many, varied, ever-changing, and
#                        eternal libre software projects."
#    },
# }
...
# output / TRANSLATION[lang] / AUTHOR_PATH / author RSS_EXTENSION (RSS feed for author)
# (translatable)
# AUTHOR_PATH = "authors"
...
# INDEXES_TITLE = ""
#
# (translatable) If the following is empty, defaults to ' [old posts,] page %d'
# (see above):
# INDEXES_PAGES = ""
#
...
# {remaining_reading_time}      An estimate of how long it will take to read the post,
#                               sans the teaser.
...
#         processEscapes: true
#     },
#     displayAlign: 'center', // Change to 'left' if you want left-aligned equations.
#     "HTML-CSS": {
...
# Options to be passed to markdown extensions
